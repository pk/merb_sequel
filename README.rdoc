...
Ruby 1.9.1:
Sequel 2.11.0:: All pass excetp session spec failing due to Marshall issues.
Sequel 2.12.0:: All pass excetp session spec failing due to Marshall issues.
Sequel 3.::     All pass excetp session spec failing due to Marshall issues.
